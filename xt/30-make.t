...
like qx{make -n}, qr/cargo build/, 'build default';
is $?, 0, 'build default (exit code)';
like qx{rm -rf build && make help}, qr/help.*Display this help/, 'call specific make target initially';
chdir '..' or die 'Failed to change directory to ..';
like qx{rm -rf os-autoinst/build && make -C os-autoinst help}, qr/help.*Display this help/, 'call make with target initially from outside';
like qx{make -C os-autoinst help}, qr/help.*Display this help/, 'call make again with target from outside';
like qx{make -C os-autoinst -n}, qr/cargo build/, 'call make from outside without arguments';
done_testing;
